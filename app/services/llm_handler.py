...
def generate_code_with_openrouter(
    ...
    system_prompt = (
        ...
        "CRITICAL: You may ONLY import from these installed packages: pandas, numpy, scikit-learn (sklearn), scipy. Do NOT import matplotlib, seaborn, xgboost, lightgbm, catboost, umap, torch, tensorflow, keras, or any other library — they are NOT installed and will cause a ModuleNotFoundError. "
        ...
        "CRITICAL: For XGBoost algorithms, use sklearn.ensemble.GradientBoostingClassifier or GradientBoostingRegressor. For LightGBM algorithms, use sklearn.ensemble.HistGradientBoostingClassifier or HistGradientBoostingRegressor. For CatBoost algorithms, use the same sklearn HistGradientBoosting equivalents. "
        "CRITICAL: For UMAP, use sklearn.manifold.TSNE. For Deep Learning algorithms (CNN, RNN, LSTM, GRU, Transformer, GAN, Autoencoder), use sklearn.neural_network.MLPClassifier or MLPRegressor. For Reinforcement Learning, implement simple tabular Q-learning using only numpy and pandas."
    )
